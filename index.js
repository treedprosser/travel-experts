...
//Stating constants and node modules to load - WM
...
//Setting up EJS and setting paths - WM
...
// Connect to the travelexperts database -TP
...
//Stating variables for server -WM
var port = 8000;
...
// app.get's to render the home page - WM
app.get("/", (req,res)=>{
    res.render("index");
});
...
// app.get to render the contact information page and query the database - TP
...
//app.get to render the travel packages from database - TM
...
// app.get to render the registration - WM
...
// Form action from register page to insert into database and push to thanks page - WM
...
// app.get to render thanks page - TP - updated to receive travel package information - WM
